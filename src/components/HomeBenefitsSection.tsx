    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      <Card className="bg-card border-border shadow-md hover:shadow-lg transition-shadow">
        <CardContent className="p-6 space-y-4">
          ...
          <h3 className="text-xl font-semibold text-center text-foreground">Cross-Platform Access</h3>
      ...
      <Card className="bg-card border-border shadow-md hover:shadow-lg transition-shadow">
        <CardContent className="p-6 space-y-4">
          ...
          <h3 className="text-xl font-semibold text-center text-foreground">Time-Saving Tools</h3>
          <p className="text-sm text-muted-foreground text-center">
      ...
      <Card className="bg-card border-border shadow-md hover:shadow-lg transition-shadow">
        <CardContent className="p-6 space-y-4">
          ...
          <h3 className="text-xl font-semibold text-center text-foreground">Enhanced Communication</h3>
          <p className="text-sm text-muted-foreground text-center">
      ...
      <Card className="bg-card border-border shadow-md hover:shadow-lg transition-shadow">
        <CardContent className="p-6 space-y-4">
          ...
          <h3 className="text-xl font-semibold text-center text-foreground">Easy to Use</h3>
          <p className="text-sm text-muted-foreground text-center">
