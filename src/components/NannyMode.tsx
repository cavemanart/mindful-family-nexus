    ...
    return (
      <div className="space-y-6">
        <div className="text-center">
          ...
          <p className="text-gray-600">Enter PIN to access important family information</p>
        </div>

        <Card className="max-w-md mx-auto">
          <CardHeader>
            <CardTitle className="text-center">Enter Access PIN</CardTitle>
          </CardHeader>
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Important information for caregivers</p>
        </div>
        <Button 
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className={`text-lg font-mono ${showCodes ? 'text-gray-800' : 'text-transparent bg-gray-300 rounded select-none'}`}>
                        {showCodes ? item.code : '••••••••'}
                      </p>
                    </div>
                    {showCodes && (
