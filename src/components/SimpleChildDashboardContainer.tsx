...
interface SimpleChildDashboardContainerProps {
  childData: {
    child_id: string;
    child_name: string;
...
const SimpleChildDashboardContainer: React.FC<SimpleChildDashboardContainerProps> = ({ childData, onLogout }) => {
...
export default SimpleChildDashboardContainer;
