  ...
  <Card className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-950/30 dark:to-orange-950/30 border-yellow-200 dark:border-yellow-700">
    <CardHeader>
      <CardTitle className="flex items-center gap-2 text-yellow-800 dark:text-yellow-100">
        <Star className="text-yellow-600 dark:text-yellow-300" size={24} />
    ...
    <CardContent>
      <div className="flex items-center justify-between mb-4">
        <div>
          <p className="text-3xl font-bold text-yellow-600 dark:text-yellow-300">{totalPoints} Points</p>
          <p className="text-sm text-muted-foreground dark:text-gray-400">This week</p>
        </div>
        <div className="text-center">
          <div className="text-4xl mb-2">{reward.icon}</div>
          <Badge className={`${reward.color} font-semibold bg-white dark:bg-gray-800 border dark:text-gray-100`}>
            {reward.level}
          </Badge>
        </div>
      </div>
