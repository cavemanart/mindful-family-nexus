...
interface SimpleChildrenDashboardProps {
  selectedHousehold: { id: string } | null;
}

const SimpleChildrenDashboard = ({ selectedHousehold }: SimpleChildrenDashboardProps) => {
  ...
  const { children, loading: childrenLoading, refetch: refetchChildren } = useSimpleChildren(selectedHousehold.id);
...
export default SimpleChildrenDashboard;
