...
import { useSimpleChildren } from '@/hooks/useSimpleChildren';
import { useAuth } from '@/hooks/useAuth';
import { toast } from 'sonner';
import { Household } from '@/hooks/useHouseholds';

interface SimpleChildManagementProps {
...
const SimpleChildManagement: React.FC<SimpleChildManagementProps> = ({ selectedHousehold }) => {
  const { user } = useAuth();
  const { children, loading, createChild, updateChild, deleteChild, refetch } = useSimpleChildren(selectedHousehold.id);
...
export default SimpleChildManagement;
